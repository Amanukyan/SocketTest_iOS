...
io.on('connection', function(clientSocket){
  ...
  clientSocket.on('touchPosition', function(clientNickname, position){
    var currentDateTime = new Date().toLocaleString();
    io.emit('newTouchPosition', clientNickname, position, currentDateTime);
  });

  clientSocket.on('touchEnded', function(clientNickname){
    var currentDateTime = new Date().toLocaleString();
    io.emit('touchEnded', clientNickname, currentDateTime);
  });
